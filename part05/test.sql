...
/* Done
   Explanation:
    ...
    datePosted: DATETIME with default CURRENT_TIMESTAMP, tracks down to the microsenond when the listing was created.
    added ON DELETE CASCADE to maintain data integrity.
*/
...
/* DONE
    Explanation:
    Changed email length to 191 from 100 to match with AppUser table email length.
*/
...
/* DONE
    ...
    datePosted: DATETIME with default CURRENT_TIMESTAMP to track when the review was posted.
    added on Delete cascade to maintain data integrity.
*/
